...
describe 'puppet::config' do
  ...
  context 'agent' do
    context 'on' do
      ...
      it 'have an [agent] block' do
        is_expected.to contain_file('puppet.conf').with_content(/^\[agent\]$/)
    ...
    context 'off' do
      ...
      it 'no [agent] block' do
        is_expected.to contain_file('puppet.conf').without_content(/^\[agent\]$/)
      end # no [agent] block
    end # off
  end # agent
  ...
  context 'aliases' do
    context 'exist' do
      ...
      it 'dns_alt_names entry' do
        is_expected.to contain_file('puppet.conf').
          with_content(/^\s+dns_alt_names\s+=\s+client.invalid, foo, bar$/)
      end
    end # exist
    ...
    context 'do not exist' do
      ...
      it 'no dns_alt_names entry' do
        is_expected.to contain_file('puppet.conf').
          without_content(/^\s+dns_alt_names\s+=\s+.*$/)
      end
    end # do not exist
    ...
    context 'bad aliases' do
      ...
      it do
        is_expected.to raise_error(Puppet::Error, /expects an Array/)
      end
    end # bad aliases
  end # aliases
  ...
  context 'autosign' do
    ...
    context 'bad' do
      ...
      it 'fail' do
        is_expected.to raise_error(Puppet::Error, /expects a String/)
      end # fail
    end
  end # autosign
  ...
  context 'env_timeout' do
    ...
    context 'invalid string' do
      ...
      it do
        is_expected.to raise_error(Puppet::Error, /expects an Integer/)
      end
    end
  ...
  context 'extra_agent' do
    ...
    context 'no agent block' do
      ...
      it do
        is_expected.to contain_file('puppet.conf').without_content(/^\s+foo$/)
      end
    end
  ...
  context 'is_ca' do
    context 'on' do
      ...
      it 'set ca = true' do
        is_expected.to contain_file('puppet.conf').with_content(/^\s+ca\s+= true$/)
      end
    end
    ...
    context 'off' do
      ...
      it 'set ca = true' do
        is_expected.to contain_file('puppet.conf').with_content(/^\s+ca\s+= false$/)
      end
    end
    ...
    context 'bad' do
      ...
      it 'fail' do
        is_expected.to raise_error(Puppet::Error, /expects a Boolean/)
  ...
  context 'master' do
    context 'on' do
      ...
      it 'have an [master] block' do
        is_expected.to contain_file('puppet.conf').with_content(/^\[master\]$/)
    ...
    context 'off' do
      ...
      it 'have no [master] block' do
        is_expected.to contain_file('puppet.conf').without_content(/^\[master\]$/)
  ...
  context 'reports' do
    ...
    context 'bad reports' do
      ...
      it { is_expected.to raise_error(Puppet::Error, /expects an Array/) }
    end # bad reports
  end # reports
  ...
  context 'use_puppetdb' do
    ...
    context 'bad' do
      ...
      it { is_expected.to raise_error(Puppet::Error, /expects a Boolean/) }
    end
  end # use_puppetdb
